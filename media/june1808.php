...
<html>
	<head>
		...
		<title>Big Dog Surf Camp - Media</title>
	...
	<hr/>
					  ...
					  <div id="fsDemo" style="height:400px;width:640px;">
  
   </div>
   <script type="text/javascript">
   var cesc = new flickrshow("fsDemo", {flickr_photoset: "72157613575947630"});
   </script>
    <p>June 19th, 2008. Photos by Laura Kudritzki</p>
				...
				<div id="footer">
				</strong><span>&copy; Big Dog Surf Camp
				<a href="mailto:bigdogsurfcamp@gmail.com" target="_blank">bigdogsurfcamp@gmail.com</a>&nbsp;|&nbsp;
				Phone: (415) 518-3805&nbsp;|&nbsp;
				<a href=http://maps.google.com/maps?f=d&hl=en&geocode=&saddr=&daddr=PROOF+LAB&sll=40.979898,-105.556641&sspn=33.964475,58.974609&ie=UTF8&z=16>Get Directions</a>
				</div>
